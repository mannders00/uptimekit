...
for environment, port in [('dev', 8001), ('prod', 8002)]:
    values = {
        ...
        'SITE_URL': 'https://localhost:8443' if environment == 'dev' else 'https://uptimekit.masoftware.net',
        'DJANGO_CSRF_TRUSTED_ORIGINS': 'https://localhost:8443' if environment == 'dev' else 'https://uptimekit.masoftware.net,https://localhost:8444',
